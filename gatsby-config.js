const config = {
  ...
  shortTitle: 'FM Huddle landing page',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Huddle landing page with a single introductory section" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-huddle-landing-page.netlify.app',
